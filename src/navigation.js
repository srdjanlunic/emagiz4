...
export const navigation = computed(() => [
  {
    ...
    links: [
      ...
      { name: 'Systems', to: '/systems', icon: 'M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z' },
      { name: 'Notifications', to: '/notifications', icon: 'M10 5a2 2 0 114 0c0 7.667 5.333 11.333 8 12v1H2v-1c2.667-.667 8-4.333 8-12zM9 21h6' },
    ],
  },
  {
    name: 'Vulnerabilities',
    links: [
      { name: 'CVEs', to: '/cve', icon: 'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.34 16.5c-.77.833.192 2.5 1.732 2.5z' },
      { name: 'Escalations', to: '/escalations', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
    ],
    roles: ['security_officer', 'admin', 'technical_expert'],
  },
  {
    name: 'Admin',
    links: [
